/**
 * @fileoverview Independent learner course outline — lessons, progress, AI crop scanner.
 */

import { LessonRow, NolwaziActionsModal, ScreenHeader } from '@/components/shared';
import { CropScanCard } from '@/components/shared/molecules/CropScanCard';
...
export default function IndependentCourseDetailScreen() {
    ...
    <View className="flex-1" style={{ backgroundColor: APP_BACKGROUND_COLOR }}>
      ...
      <ScrollView className="flex-1 -mt-4" showsVerticalScrollIndicator={false}>
          ...
          <View className={surfaceContentPanel}>
            <View className="flex-row items-center justify-between mb-2">
              ...
              <View className="bg-primary-500/12 px-3 py-1.5 rounded-full ml-2">
                <Text className="text-primary-900 text-[11px] font-medium tracking-wide">
                  {lessons.length} lessons
                </Text>
              </View>
            </View>
            <Text className="text-earth-500 text-sm leading-5">
              Work through lessons at your own pace. Each lesson builds on the last.
            </Text>
            <View className="mt-3 items-start">
              ...
              >
                ...
                <Text className="text-primary-900 text-xs font-medium ml-2">
                  Ask Nolwazi about this course
                </Text>
              </TouchableOpacity>
            </View>
          </View>
            ...
            return (
              <LessonRow
                ...
                onPress={
                  state === 'locked'
                    ? undefined
                    : () => router.push({ pathname: '/independent/lesson/[id]', params: { id: lesson.id } })
                }
        ...
        <View style={{ marginTop: 24, marginBottom: 8, paddingHorizontal: 20 }}>
          <Text style={{ color: '#1c1917', fontSize: 15, fontWeight: '300', letterSpacing: -0.2, marginBottom: 4 }}>
            Field tools
          </Text>
          <Text style={{ color: '#a8a29e', fontSize: 12, fontWeight: '300', marginBottom: 12 }}>
            Apply what you're learning — scan your crop for instant AI feedback.
          </Text>
        </View>
        <CropScanCard courseTitle={course?.title} />
